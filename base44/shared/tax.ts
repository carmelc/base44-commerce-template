/**
 * Tax-rate matching and application, following WooCommerce semantics:
...
export function matchTaxRates(allRates: any[], addr: TaxAddress, taxClass: string): any[] {
  ...
  // Woo: only the first matching rate per priority level applies
 ...
 * mirroring Woo's calc_inclusive_tax: compound rates are unwound from the
