 ...
 * template ships with (US, CA, AU — the same trio most Woo installs care about;
 * other countries use a free-text state field). Equivalent of Woo's
 * /data/countries reference endpoint. Extend freely — plain static data.
 */
